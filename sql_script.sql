...
CREATE VIEW user_classes AS SELECT U.uin, U.first_name, U.m_initial, U.last_name, UC.ce_num, UC.class_status, UC.semester, UC.yr, C.* FROM college_student U JOIN class_enrollment UC ON U.uin = UC.uin JOIN classes C on C.class_id = UC.class_id;
...
CREATE VIEW user_internships AS SELECT U.uin, U.first_name, U.m_initial, U.last_name, UI.ia_num, UI.intern_status, UI.yr, I.* FROM college_student U JOIN intern_app UI ON U.uin = UI.uin JOIN internship I on I.intern_id = UI.intern_id;
...
CREATE VIEW user_certifications AS SELECT U.uin, U.first_name, U.m_initial, U.last_name, UC.certe_num, UC.cert_status, UC.training_status, UC.semester, UC.program_num, UC.yr, C.* FROM college_student U JOIN cert_enrollment UC ON U.uin = UC.uin JOIN certification C on C.cert_id = UC.cert_id;
